...
export class GalleryInitial1788696680213 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `CREATE TABLE "product_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text NOT NULL, "id" SERIAL NOT NULL, "baseId" integer, "customFieldsMaterial" character varying(255), "customFieldsSeals" text, "customFieldsInscriptions" text, "customFieldsCollectionstory" text, CONSTRAINT "PK_62d00fbc92e7a495701d6fee9d5" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "product" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "enabled" boolean NOT NULL DEFAULT true, "id" SERIAL NOT NULL, "featuredAssetId" integer, "customFieldsHighresolutionassetid" integer, "customFieldsPrivateoriginalassetid" integer, "customFieldsLegacyartworkid" character varying(255), "customFieldsYeartext" character varying(255), "customFieldsDimensionstext" character varying(255), "customFieldsIsdirectpurchase" boolean DEFAULT false, "customFieldsPricevisibility" character varying(255) DEFAULT 'INQUIRY', "customFieldsSourcereferences" text, "customFieldsVerificationstatus" character varying(255) DEFAULT 'UNVERIFIED', CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "asset_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "name" character varying NOT NULL, "id" SERIAL NOT NULL, "baseId" integer, "customFieldsAlt" character varying(255), CONSTRAINT "PK_2f22e63eefeef14d245bdb956b6" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "customer" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" character varying, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phoneNumber" character varying, "emailAddress" character varying NOT NULL, "id" SERIAL NOT NULL, "userId" integer, "customFieldsBirthday" character varying(255), "customFieldsGender" character varying(255), "customFieldsPreferredlanguage" character varying(255), "customFieldsMembershipstatus" character varying(255) DEFAULT 'PENDING', "customFieldsMembershiptier" character varying(255) DEFAULT 'APPLICANT', CONSTRAINT "REL_3f62b42ed23958b120c235f74d" UNIQUE ("userId"), CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "artist" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "slug" character varying NOT NULL, "legacyArtistId" character varying, "status" character varying NOT NULL DEFAULT 'DRAFT', "publishedAt" TIMESTAMP, "sortOrder" integer NOT NULL DEFAULT '0', "templateKey" character varying, "contentBlocks" text, "id" SERIAL NOT NULL, "avatarAssetId" integer, "heroAssetId" integer, CONSTRAINT "PK_55b76e71568b5db4d01d3e394ed" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
            `CREATE UNIQUE INDEX "IDX_d3e491c5109118d2a6eb5b16a4" ON "artist" ("slug") `,
            undefined,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_1c556dafeb95b2586477a7ac12" ON "artist" ("legacyArtistId") `,
            undefined,
        );
        await queryRunner.query(
            `CREATE TABLE "artist_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "name" character varying NOT NULL, "quote" character varying NOT NULL DEFAULT '', "summary" text NOT NULL DEFAULT '', "lineageTitle" character varying NOT NULL DEFAULT '', "lineageParagraph1" text NOT NULL DEFAULT '', "lineageParagraph2" text NOT NULL DEFAULT '', "exhibitionSummary" text NOT NULL DEFAULT '', "seoTitle" character varying NOT NULL DEFAULT '', "seoDescription" text NOT NULL DEFAULT '', "id" SERIAL NOT NULL, "baseId" integer, CONSTRAINT "PK_22155310b775dc7f769d8de10fc" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_06f803662c364e22ddd3ecbd74" ON "artist_translation" ("baseId") `,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "product_custom_fields_artists_artist" ("productId" integer NOT NULL, "artistId" integer NOT NULL, CONSTRAINT "PK_b46a91fb186cafe5d114fe9149b" PRIMARY KEY ("productId", "artistId"))`,
            undefined,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_dc6de88ce1d0315bf8d7229ae6" ON "product_custom_fields_artists_artist" ("productId") `,
            undefined,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_74ea4397881f41cba84f6d03e0" ON "product_custom_fields_artists_artist" ("artistId") `,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "product" ADD CONSTRAINT "FK_b310154708e1ad5c2c4b7618f5b" FOREIGN KEY ("customFieldsHighresolutionassetid") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "product" ADD CONSTRAINT "FK_828a0532076cc5ec02ebe72502c" FOREIGN KEY ("customFieldsPrivateoriginalassetid") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "artist" ADD CONSTRAINT "FK_9c17415c9e011823aabb5e97df4" FOREIGN KEY ("avatarAssetId") REFERENCES "asset"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "artist" ADD CONSTRAINT "FK_8aab0b50a0f62c45a44c04e3450" FOREIGN KEY ("heroAssetId") REFERENCES "asset"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "artist_translation" ADD CONSTRAINT "FK_06f803662c364e22ddd3ecbd747" FOREIGN KEY ("baseId") REFERENCES "artist"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "product_custom_fields_artists_artist" ADD CONSTRAINT "FK_dc6de88ce1d0315bf8d7229ae6e" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "product_custom_fields_artists_artist" ADD CONSTRAINT "FK_74ea4397881f41cba84f6d03e07" FOREIGN KEY ("artistId") REFERENCES "artist"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
            undefined,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `ALTER TABLE "product_custom_fields_artists_artist" DROP CONSTRAINT "FK_74ea4397881f41cba84f6d03e07"`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "product_custom_fields_artists_artist" DROP CONSTRAINT "FK_dc6de88ce1d0315bf8d7229ae6e"`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "artist_translation" DROP CONSTRAINT "FK_06f803662c364e22ddd3ecbd747"`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "artist" DROP CONSTRAINT "FK_8aab0b50a0f62c45a44c04e3450"`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "artist" DROP CONSTRAINT "FK_9c17415c9e011823aabb5e97df4"`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "product" DROP CONSTRAINT "FK_828a0532076cc5ec02ebe72502c"`,
            undefined,
        );
        await queryRunner.query(
            `ALTER TABLE "product" DROP CONSTRAINT "FK_b310154708e1ad5c2c4b7618f5b"`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_74ea4397881f41cba84f6d03e0"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_dc6de88ce1d0315bf8d7229ae6"`, undefined);
        await queryRunner.query(`DROP TABLE "product_custom_fields_artists_artist"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_06f803662c364e22ddd3ecbd74"`, undefined);
        await queryRunner.query(`DROP TABLE "artist_translation"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_1c556dafeb95b2586477a7ac12"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_d3e491c5109118d2a6eb5b16a4"`, undefined);
